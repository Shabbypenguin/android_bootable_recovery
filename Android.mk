...
RECOVERY_NAME := OUDhs CWM Touch Req0very
endif
endif

RECOVERY_VERSION := $(RECOVERY_NAME) v1.0.3.4
...
BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU TARGET_USE_CUSTOM_LUN_FILE_PATH BOARD_RECOVERY_POST_EXIT TARGET_DEVICE
